...
import veterinarskaambulanta.Ljiubimac;
import veterinarskaambulanta.Macka;
import veterinarskaambulanta.Pas;
import veterinarskaambulanta.Red;
	...
	private void obradiProzoviSledeceg(Button prozoviSledecegBtn, TextArea ispisTA) {
		...
		prozoviSledecegBtn.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent event) {
				...
				Ljiubimac sledeci = red.prozoviSledeceg();
